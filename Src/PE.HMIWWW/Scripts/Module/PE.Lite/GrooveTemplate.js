function AddNew() {
    ...
    OpenInPopupWindow({
        controller: "GrooveTemplate", method: "AddGrooveTemplateDialog", width: 600, afterClose: RefreshData
    });
}
function EditData(itemId) {
    ...
    OpenInPopupWindow({
        controller: "GrooveTemplate", method: "EditGrooveTemplateDialog", width: 600, data: { id: itemId }, afterClose: RefreshData
    });
}
