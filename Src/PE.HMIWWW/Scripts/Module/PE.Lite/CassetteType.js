function AddNew() {
    ...
    OpenInPopupWindow({
        controller: "CassetteType", method: "AddCassetteTypeDialog", width: 600, afterClose: RefreshData
    });
}
function EditData(itemId) {
    ...
    OpenInPopupWindow({
        controller: "CassetteType", method: "EditCassetteTypeDialog", width: 600, data: { id: itemId }, afterClose: RefreshData
    });
}
